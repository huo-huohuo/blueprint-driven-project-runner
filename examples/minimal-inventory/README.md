...
python scripts/generate_goal_prompt.py --project examples/minimal-inventory --module "Inventory" --record INVENTORY-IMPORT-IDEMPOTENCY-001 --work-slice WS-IMPORT-001
```
