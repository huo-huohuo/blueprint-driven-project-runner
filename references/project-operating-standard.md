...
5. Module blueprint files and execution ledger.
...
Summary briefs, PRD paragraphs, vague plans, and feature lists do not authorize coding. Broad work requires ready executable blueprint records and an execution contract.
...
After blueprints are ready, generate a goal prompt before long-running execution. The goal prompt must make blueprint completion the first principle.
